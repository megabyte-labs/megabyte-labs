...
import { p as pixelize } from './utils-fb465d6a.js';
...
const CodeTabs = class {
  constructor(hostRef) {
    ...
    this.tabs = new Proxy({}, this.tabsHandler);
    this.data = undefined;
    this.activeTab = {
      index: 0,
      left: '0px',
  ...
  async setActive(target) {
    ...
    this.activeTab = Object.assign(Object.assign({}, this.activeTab), { left: pixelize(target.offsetLeft), width: pixelize(target.offsetWidth) });
  ...
  render() {
    return (h(Host, { style: {
      ...
      } }, h("nav", null, h("div", { class: "tabs-wrapper" }, this.data.tabs.map((tab, i) => (h("button", { class: {
        active: this.activeTab.index === i,
      }, ref: el => !this.tabs.hasOwnProperty(i) && (this.tabs[i] = el), onClick: ev => {
        this.activeTab.index = i;
        this.handleTabSelect(ev);
      } }, tab))))), h("div", { class: "background" }, h("div", { class: "code-wrapper" }, this.data.code.map((code, i) => (h("article", null, h("code-snippet", { language: this.data.languages.length === 1
        ? this.data.languages[0]
        : this.data.languages[i], code: code }))))))));
  }
  get elm() { return getElement(this); }
};
CodeTabs.style = codeTabsCss;

export { CodeTabs as C };

//# sourceMappingURL=code-tabs-50b6200a.js.map