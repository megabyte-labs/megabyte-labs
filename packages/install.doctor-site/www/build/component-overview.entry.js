import { h, r as registerInstance } from './index-9fe124a3.js';
import { c as coreExamples, w as webExamples } from './examples-04b82519.js';
import { h as href } from './index-9ec0b90a.js';
import { c as createCommonjsModule } from './_commonjsHelpers-9bc404fc.js';
import { C as Col, a as CardContent } from './index-40ae1b73.js';
import './exports-14d8c63d.js';
import './utils-dcf93146.js';
import { d as dashToCamel } from './utilities-8121db63.js';
...
import './PrismicContent-ac78525c.js';
import './slugify-e65e71c9.js';
import './tracking-service-c64257af.js';
import './PrismicResponsiveImage-d2ecff99.js';

const timestamp = "2020-11-10T07:24:11";
const compiler = {
	name: "@stencil/core",
	version: "2.0.3",
...
const components = [
	...
	},
	{
		...
		props: [
			...
			{
				name: "routing",
				type: "RoutingProps | RoutingProps[]",
				mutable: false,
				reflectToAttr: false,
				docs: "",
				docsTags: [
	...
	{
		filePath: "./src/web/components/site-backdrop/site-backdrop.tsx",
		encapsulation: "scoped",
		tag: "site-backdrop",
		readme: "# site-backdrop\n\n\n",
		docs: "",
		docsTags: [
		],
		usage: {
...
const getHeader = (component) => {
  ...
  return h("div", { innerHTML: marked_1(markdownHeader) });
};
  ...
  return (h("section", null,
    h("table", null,
      ...
      h("tbody", null, customProps.map(prop => (h("tr", null,
        ...
        h("td", { innerHTML: marked_1(prop.docs) }))))))));
};
const capitalizeFirstLetter = string => {
  return string.charAt(0).toUpperCase() + string.slice(1);
};

const ComponentOverview = class {
  constructor(hostRef) {
...
ComponentOverview.style = "table {\n      padding: var(--space-6) 0 var(--space-10);\n    }\n    th {\n      background: var(--c-indigo-20);\n    }\n    .examples-title {\n      margin-bottom: var(--space-6);\n      background: var(--c-indigo-20);\n    }\n    .readme img {\n      border: 2px solid var(--c-carbon-90);\n      max-width: 100%;\n    }";

export { ComponentOverview as component_overview };

//# sourceMappingURL=component-overview.entry.js.map