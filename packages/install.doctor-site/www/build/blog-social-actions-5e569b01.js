...
const BlogSocialActions = class {
  constructor(hostRef) {
    ...
    this.render = () => (h(Host, { class: {
        ...
        'column': this.column,
        'loaded': this.loaded,
      } }, h("a", { href: this.facebookUrl.join(''), onClick: (e) => this.shareFacebook(e), target: "_blank", rel: "noopener" }, facebookRoundedLogo({ main: '#CED6E0' }, { width: 20, height: 20, class: 'facebook' })), h("a", { href: this.twitterUrl.join(''), onClick: (e) => this.shareTwitter(e), target: "_blank", rel: "noopener" }, twitterLogo({ main: '#CED6E0' }, { width: 20, height: 16, class: 'twitter' })), h("a", { href: this.linkedInUrl.join(''), onClick: (e) => this.shareLinkedIn(e), target: "_blank", rel: "noopener" }, linkedInLogo({ main: '#CED6E0' }, { width: 20, height: 20, class: 'linked-in' }))));
    this.post = undefined;
    this.column = false;
    this.loaded = false;
...
BlogSocialActions.style = blogSocialActionsCss;

export { BlogSocialActions as B };

//# sourceMappingURL=blog-social-actions-5e569b01.js.map